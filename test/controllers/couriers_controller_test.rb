...
class CouriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create courier" do
    assert_difference('Courier.count') do
      post couriers_url, params: { courier: { address: @courier.address, name: @courier.name } }
    end
  ...
  test "should update courier" do
    patch courier_url(@courier), params: { courier: { address: @courier.address, name: @courier.name } }
